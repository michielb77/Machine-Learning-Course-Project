...
To evaluate the model, we split the dataset into a training and a test set. The test set that is provided with the assignment cannot be used for this, because it does not contain classes. It is intended to be used for the quiz. 

```{r splitting data}
set.seed(3456) # for reproducability

inTrain <- caret::createDataPartition(training$user_name, p = .7, list = FALSE)
